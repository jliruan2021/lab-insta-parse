...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //Step 1
        ParseSwift.initialize(applicationId: "n5RgBzW3iZ4epxHwzWSy86o4A4Fb4fFnwTXVavbq",
                              clientKey: "H8bd0aFY2BvrveD5IkPx9NsAOL6Mn4PoyaW5mFx6",
        ...
        // step 3. Instantiate the test parse object
        var score = GameScore()
...
// step 2. Create your own value type `ParseObject`.
